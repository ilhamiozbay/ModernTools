...
{
    public partial class ModernToolsBaseContext : DbContext
    {
        public ModernToolsBaseContext()
        {
        }

        public ModernToolsBaseContext(DbContextOptions<ModernToolsBaseContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=ModernTools;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ExchangeType>(entity =>
            {
                ...
                entity.Property(e => e.ExchangeName).HasMaxLength(10)
                .IsFixedLength(true);
